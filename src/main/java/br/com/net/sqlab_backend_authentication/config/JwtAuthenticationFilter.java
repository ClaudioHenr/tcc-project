...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        System.out.println("Intercepting request to: " + requestURI);

        if (requestURI.startsWith("/auth/") || requestURI.equals("/professors/create") || requestURI.equals("/students/create")) {
